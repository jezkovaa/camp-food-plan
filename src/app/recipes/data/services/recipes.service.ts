      ...
      variants: [
        {
          ...
          ingredients: [
            ...
            { name: 'paradajková omáčka', quantity: 150, unit: 'ml' },
            { name: 'cesnak', quantity: 2, unit: 'strúčiky' },
            { name: 'oregano', quantity: 1, unit: 'čajová lyžička' }
          ],
        ...
        },
        {
          ...
          ingredients: [
            { name: 'špagety', quantity: 200, unit: 'g' },
            { name: 'bazalkové pesto', quantity: 100, unit: 'g' },
      ...
      id: 2, name: 'Palačinky', courses: [Course.SNACK], variants: [
        {
          ...
          ingredients: [
            { name: 'múka', quantity: 200, unit: 'g' },
            { name: 'mlieko', quantity: 300, unit: 'ml' },
            { name: 'vajcia', quantity: 2, unit: 'ks' },
            { name: 'džem', quantity: 100, unit: 'g' }
          ],
          restrictions: [FoodRestriction.VEGETARIAN],
          proceeding: [
        ...
        },
        {
          ...
          ingredients: [
            ...
            { name: 'mlieko', quantity: 300, unit: 'ml' },
            { name: 'vajcia', quantity: 2, unit: 'ks' },
            { name: 'nutella', quantity: 100, unit: 'g' }
          ],
          restrictions: [FoodRestriction.VEGETARIAN],
          proceeding: [
            { order: 1, description: 'Zmiešajte múku, mlieko a vajcia' },
        ...
        },
        {
          ...
          ingredients: [
            ...
            { name: 'mlieko', quantity: 300, unit: 'ml' },
            { name: 'vajcia', quantity: 2, unit: 'ks' },
            { name: 'tvaroh', quantity: 150, unit: 'g' },
            { name: 'ovocie', quantity: 100, unit: 'g' }
          ],
          restrictions: [FoodRestriction.VEGETARIAN],
          proceeding: [
            { order: 1, description: 'Zmiešajte múku, mlieko a vajcia' },
      ...
      id: 3, name: 'Zeleninové Stir Fry', courses: [Course.DINNER, Course.LUNCH], variants: [
        {
          ...
          ingredients: [
            { name: 'brokolica', quantity: 200, unit: 'g' },
            { name: 'mrkva', quantity: 150, unit: 'g' },
            { name: 'paprika', quantity: 150, unit: 'g' },
            { name: 'sójová omáčka', quantity: 50, unit: 'ml' }
          ],
      ...
      id: 4, name: 'Kapustnica', courses: [Course.DINNER], variants: [
        {
          ...
          ingredients: [
            { name: 'kyslá kapusta', quantity: 500, unit: 'g' },
            { name: 'klobása', quantity: 200, unit: 'g' },
            { name: 'zemiaky', quantity: 300, unit: 'g' },
            { name: 'cesnak', quantity: 3, unit: 'strúčiky' },
      ...
      id: 5, name: 'Bryndzové halušky', courses: [Course.LUNCH, Course.DINNER], variants: [
        {
          ...
          ingredients: [
            { name: 'zemiaky', quantity: 500, unit: 'g' },
            { name: 'múka', quantity: 200, unit: 'g' },
            { name: 'bryndza', quantity: 250, unit: 'g' },
      ...
      id: 6, name: 'Guláš', courses: [Course.LUNCH, Course.DINNER], variants: [
        {
          ...
          ingredients: [
            { name: 'hovädzie mäso', quantity: 500, unit: 'g' },
            { name: 'cibuľa', quantity: 200, unit: 'g' },
            { name: 'paprika', quantity: 150, unit: 'g' },
            { name: 'paradajkový pretlak', quantity: 100, unit: 'g' },
            { name: 'cesnak', quantity: 3, unit: 'strúčiky' }
          ],
          restrictions: [],
          proceeding: [
      ...
      id: 7, name: 'Caesar šalát', courses: [Course.LUNCH, Course.DINNER], variants: [
        {
          ...
          ingredients: [
            { name: 'rímsky šalát', quantity: 200, unit: 'g' },
            { name: 'kuracie prsia', quantity: 150, unit: 'g' },
            { name: 'parmezán', quantity: 50, unit: 'g' },
            { name: 'krutóny', quantity: 50, unit: 'g' },
      ...
      id: 8, name: 'Lasagna', courses: [Course.LUNCH, Course.DINNER], variants: [
        {
          ...
          ingredients: [
            { name: 'lasagne pláty', quantity: 200, unit: 'g' },
            { name: 'mleté hovädzie mäso', quantity: 300, unit: 'g' },
            { name: 'paradajková omáčka', quantity: 200, unit: 'ml' },
            { name: 'bešamel', quantity: 200, unit: 'ml' },
            { name: 'parmezán', quantity: 100, unit: 'g' }
          ],
          restrictions: [],
          proceeding: [
      ...
      id: 9, name: 'Chicken Curry', courses: [Course.LUNCH, Course.DINNER], variants: [
        {
          ...
          ingredients: [
            { name: 'kuracie prsia', quantity: 300, unit: 'g' },
            { name: 'kokosové mlieko', quantity: 200, unit: 'ml' },
            { name: 'kari pasta', quantity: 50, unit: 'g' },
            { name: 'cibuľa', quantity: 100, unit: 'g' },
            { name: 'cesnak', quantity: 2, unit: 'strúčiky' }
          ],
      ...
      id: 10, name: 'Beef Stroganoff', courses: [Course.LUNCH, Course.DINNER], variants: [
        {
          ...
          ingredients: [
            { name: 'hovädzie mäso', quantity: 300, unit: 'g' },
            { name: 'šampiňóny', quantity: 150, unit: 'g' },
            { name: 'cibuľa', quantity: 100, unit: 'g' },
            { name: 'smotana', quantity: 200, unit: 'ml' },
            { name: 'horčica', quantity: 50, unit: 'g' }
          ],
          restrictions: [],
          proceeding: [
      ...
      id: 11, name: 'Tacos', courses: [Course.LUNCH, Course.DINNER], variants: [
        {
          ...
          ingredients: [
            { name: 'tortilly', quantity: 200, unit: 'g' },
            { name: 'mleté hovädzie mäso', quantity: 300, unit: 'g' },
            { name: 'salsa', quantity: 100, unit: 'g' },
            { name: 'šalát', quantity: 100, unit: 'g' }
          ],
          restrictions: [],
          proceeding: [
      ...
      id: 12, name: 'Pizza Margherita', courses: [Course.LUNCH, Course.DINNER], variants: [
        {
          ...
          ingredients: [
            { name: 'pizza cesto', quantity: 200, unit: 'g' },
            { name: 'paradajková omáčka', quantity: 100, unit: 'ml' },
            { name: 'mozzarella', quantity: 150, unit: 'g' },
            { name: 'bazalka', quantity: 10, unit: 'g' }
          ],
          restrictions: [FoodRestriction.VEGETARIAN],
          proceeding: [
      ...
      id: 13, name: 'Sushi', courses: [Course.LUNCH, Course.DINNER], variants: [
        {
          ...
          ingredients: [
            { name: 'sushi ryža', quantity: 200, unit: 'g' },
            { name: 'nori pláty', quantity: 5, unit: 'ks' },
            { name: 'losos', quantity: 150, unit: 'g' },
            { name: 'uhorka', quantity: 100, unit: 'g' },
            { name: 'avokádo', quantity: 100, unit: 'g' }
          ],
      ...
      id: 14, name: 'Pad Thai', courses: [Course.LUNCH, Course.DINNER], variants: [
        {
          ...
          ingredients: [
            { name: 'ryžové rezance', quantity: 200, unit: 'g' },
            { name: 'kuracie prsia', quantity: 150, unit: 'g' },
            { name: 'vajcia', quantity: 2, unit: 'ks' },
            { name: 'arašidy', quantity: 50, unit: 'g' },
            { name: 'tamari omáčka', quantity: 50, unit: 'ml' }
          ],
          restrictions: [FoodRestriction.GLUTEN_FREE],
          proceeding: [
      ...
      id: 15, name: 'Miso Soup', courses: [Course.LUNCH, Course.DINNER], variants: [
        {
          ...
          ingredients: [
            { name: 'miso pasta', quantity: 50, unit: 'g' },
            { name: 'tofu', quantity: 100, unit: 'g' },
            { name: 'wakame', quantity: 10, unit: 'g' },
            { name: 'zelená cibuľka', quantity: 20, unit: 'g' }
          ],
          restrictions: [FoodRestriction.VEGAN, FoodRestriction.GLUTEN_FREE],
          proceeding: [
      ...
      id: 16, name: 'Ratatouille', courses: [Course.LUNCH, Course.DINNER], variants: [
        {
          ...
          ingredients: [
            { name: 'baklažán', quantity: 200, unit: 'g' },
            { name: 'cuketa', quantity: 200, unit: 'g' },
            { name: 'paradajky', quantity: 200, unit: 'g' },
            { name: 'paprika', quantity: 150, unit: 'g' },
            { name: 'cesnak', quantity: 2, unit: 'strúčiky' }
          ],
          restrictions: [FoodRestriction.VEGAN, FoodRestriction.GLUTEN_FREE],
      ...
      id: 17, name: 'Falafel', courses: [Course.LUNCH, Course.DINNER], variants: [
        {
          ...
          ingredients: [
            { name: 'cícer', quantity: 200, unit: 'g' },
            { name: 'cibuľa', quantity: 100, unit: 'g' },
            { name: 'cesnak', quantity: 2, unit: 'strúčiky' },
            { name: 'petržlen', quantity: 50, unit: 'g' },
            { name: 'múka', quantity: 50, unit: 'g' }
          ],
          restrictions: [FoodRestriction.VEGAN],
          proceeding: [
      ...
      id: 18, name: 'Biryani', courses: [Course.LUNCH, Course.DINNER], variants: [
        {
          ...
          ingredients: [
            { name: 'basmati ryža', quantity: 200, unit: 'g' },
            { name: 'kuracie prsia', quantity: 150, unit: 'g' },
            { name: 'jogurt', quantity: 100, unit: 'g' },
            { name: 'cibuľa', quantity: 100, unit: 'g' },
            { name: 'kari korenie', quantity: 20, unit: 'g' }
          ],
          restrictions: [],
          proceeding: [
      ...
      id: 19, name: 'Chili con Carne', courses: [Course.LUNCH, Course.DINNER], variants: [
        {
          ...
          ingredients: [
            { name: 'mleté hovädzie mäso', quantity: 300, unit: 'g' },
            { name: 'červená fazuľa', quantity: 200, unit: 'g' },
            { name: 'paradajková omáčka', quantity: 200, unit: 'ml' },
            { name: 'cibuľa', quantity: 100, unit: 'g' },
            { name: 'cesnak', quantity: 2, unit: 'strúčiky' }
          ],
      ...
      id: 20, name: 'Quiche Lorraine', courses: [Course.LUNCH, Course.DINNER], variants: [
        {
          ...
          ingredients: [
            { name: 'lístkové cesto', quantity: 200, unit: 'g' },
            { name: 'slanina', quantity: 150, unit: 'g' },
            { name: 'vajcia', quantity: 3, unit: 'ks' },
            { name: 'smotana', quantity: 200, unit: 'ml' },
            { name: 'syr', quantity: 100, unit: 'g' }
          ],
          restrictions: [],
          proceeding: [
